            ...
            <div class="lg:col-span-2">
                <div class="lg:sticky lg:top-24">
                    ...
                    <nav class="flex items-center gap-2 text-xs text-gray-400 mb-4">
                        <a href="{{ route('rooms.index') }}" class="hover:text-[#2F4538] transition">Kamar</a>
                        <span>&gt;</span>
                        <a href="{{ route('rooms.index', ['lantai' => $room->floor]) }}" class="hover:text-[#2F4538] transition">Lantai {{ $room->floor }}</a>
                        <span>&gt;</span>
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                        ...
                        <div class="flex flex-col gap-3">
                            @if($room->is_available)
                                ...
                                @else
                                    <button type="button" onclick="bukaPopupAuth('login')"
                                       class="bg-[#2F4538] text-white font-semibold text-sm py-3 rounded-xl text-center hover:bg-[#26392E] transition">
                                        Pesan Sekarang
                                    </button>
                                @endauth
